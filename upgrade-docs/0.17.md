**NOT FOR SHARING!!!** This release has not been publicly announced yet. You can find out more on elm-dev, but please do not be posting this around online until the official announcement.
...
Some core packages have been renamed:
  ...
  - The functionality of `Graphics.*` now lives in `evancz/graphics`
